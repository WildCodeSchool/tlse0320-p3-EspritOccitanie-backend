...
-- lun. 22 juin 2020 15:42:30 CEST
...
CREATE TABLE IF NOT EXISTS `radiodb_eo_test`.`ro_program` (
  ...
  CONSTRAINT `fk_ro_program_ro_category1`
    FOREIGN KEY (`ro_category_category_id`)
    REFERENCES `radiodb_eo_test`.`ro_category` (`category_id`)
    ON DELETE SET NULL
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `radiodb_eo_test`.`ro_podcast` (
  ...
  CONSTRAINT `fk_ro_podcast_ro_program1`
    FOREIGN KEY (`ro_program_program_id`)
    REFERENCES `radiodb_eo_test`.`ro_program` (`program_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ro_podcast_ro_category1`
    FOREIGN KEY (`ro_category_category_id`)
    REFERENCES `radiodb_eo_test`.`ro_category` (`category_id`)
    ON DELETE SET NULL
    ON UPDATE NO ACTION);
...
CREATE TABLE IF NOT EXISTS `radiodb_eo_test`.`ro_animator_has_ro_progam` (
  ...
  CONSTRAINT `fk_ro_animator_has_ro_progam_ro_animator1`
    FOREIGN KEY (`ro_animator_animator_id`)
    REFERENCES `radiodb_eo_test`.`ro_animator` (`animator_id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ro_animator_has_ro_progam_ro_progam1`
    FOREIGN KEY (`ro_program_program_id`)
    REFERENCES `radiodb_eo_test`.`ro_program` (`program_id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `radiodb_eo_test`.`ro_podcast_has_ro_animator` (
  ...
  CONSTRAINT `fk_ro_podcast_has_ro_animator_ro_podcast1`
    FOREIGN KEY (`ro_podcast_podcast_id`)
    REFERENCES `radiodb_eo_test`.`ro_podcast` (`podcast_id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ro_podcast_has_ro_animator_ro_animator1`
    FOREIGN KEY (`ro_animator_animator_id`)
    REFERENCES `radiodb_eo_test`.`ro_animator` (`animator_id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION);
